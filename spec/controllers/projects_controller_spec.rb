  ...
  describe "GET 'index'" do
    ...
    describe "Search projects" do
      ...
      context "Using fields of study" do
        before(:each) do
          @projects = create_list(:completed_projects, rand(1..10))
          @projects_related = create_list(:completed_projects, rand(1..10)) 
      ...
      context "Using mixed filters" do
        ...
        it "should return individual projects related to Malaria" do
          ...
          set_different_properties(individual_projects, "related_student_passions", passions)
        ...
        it "should return projects related to Malaria Prevention and Web Design" do
          ...
          fields = "[\"Web Design\"]"
          projects_related_to_web_design = create_list(:completed_projects, rand(1..10))   
          set_different_properties(projects_related_to_web_design, "related_fields_of_study", fields)

          get :index, properties: {"related_fields_of_study"=>["Web Design"], "related_student_passions"=>["Malaria Prevention"]}
          expect(assigns(:projects).result).to match_array(projects_related_to_web_design.concat(projects_related_to_malaria))
        end
